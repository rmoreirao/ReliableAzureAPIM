@secure()
param subscriptions_65e1aa9d2ba5fb0068070001_displayName string

@secure()
param subscriptions_65e1aa9d2ba5fb0068070002_displayName string

@secure()
param users_1_lastName string
param service_apimmultirmoreirao_name string = 'apimmultirmoreirao'
param virtualNetworks_vnet_apim_mltd1_dev_uksouth_externalid string = '/subscriptions/afb8f550-216d-4848-b6f1-73b1bbf58f1e/resourceGroups/rg-apim-networking-mltd1-dev-uksouth-001/providers/Microsoft.Network/virtualNetworks/vnet-apim-mltd1-dev-uksouth'
param publicIPAddresses_pip_apim_mltd1_dev_uksouth_externalid string = '/subscriptions/afb8f550-216d-4848-b6f1-73b1bbf58f1e/resourceGroups/rg-apim-networking-mltd1-dev-uksouth-001/providers/Microsoft.Network/publicIPAddresses/pip-apim-mltd1-dev-uksouth'

resource service_apimmultirmoreirao_name_resource 'Microsoft.ApiManagement/service@2023-03-01-preview' = {
  name: service_apimmultirmoreirao_name
  location: 'UK South'
  sku: {
    name: 'Premium'
    capacity: 2
  ...
  properties: {
    ...
    hostnameConfigurations: [
      {
        type: 'Proxy'
        hostName: '${service_apimmultirmoreirao_name}.azure-api.net'
    ...
    virtualNetworkConfiguration: {
      subnetResourceId: '${virtualNetworks_vnet_apim_mltd1_dev_uksouth_externalid}/subnets/snet-apim-mltd1-dev-uksouth-001'
    }
    customProperties: {
    ...
    publicIpAddressId: publicIPAddresses_pip_apim_mltd1_dev_uksouth_externalid
...
resource service_apimmultirmoreirao_name_echo_api 'Microsoft.ApiManagement/service/apis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'echo-api'
  properties: {
...
resource service_apimmultirmoreirao_name_administrators 'Microsoft.ApiManagement/service/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'administrators'
  properties: {
...
resource service_apimmultirmoreirao_name_developers 'Microsoft.ApiManagement/service/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'developers'
  properties: {
...
resource service_apimmultirmoreirao_name_guests 'Microsoft.ApiManagement/service/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'guests'
  properties: {
    displayName: 'Guests'
...
resource service_apimmultirmoreirao_name_AccountClosedPublisher 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'AccountClosedPublisher'
}

resource service_apimmultirmoreirao_name_BCC 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'BCC'
}

resource service_apimmultirmoreirao_name_NewApplicationNotificationMessage 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'NewApplicationNotificationMessage'
}

resource service_apimmultirmoreirao_name_NewIssuePublisherNotificationMessage 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'NewIssuePublisherNotificationMessage'
}

resource service_apimmultirmoreirao_name_PurchasePublisherNotificationMessage 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'PurchasePublisherNotificationMessage'
}

resource service_apimmultirmoreirao_name_QuotaLimitApproachingPublisherNotificationMessage 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'QuotaLimitApproachingPublisherNotificationMessage'
}

resource service_apimmultirmoreirao_name_RequestPublisherNotificationMessage 'Microsoft.ApiManagement/service/notifications@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'RequestPublisherNotificationMessage'
}

resource service_apimmultirmoreirao_name_policy 'Microsoft.ApiManagement/service/policies@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'policy'
  properties: {
...
resource service_apimmultirmoreirao_name_default 'Microsoft.ApiManagement/service/portalconfigs@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'default'
  properties: {
...
resource service_apimmultirmoreirao_name_delegation 'Microsoft.ApiManagement/service/portalsettings@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'delegation'
  properties: {
    subscriptions: {
...
resource service_apimmultirmoreirao_name_signin 'Microsoft.ApiManagement/service/portalsettings@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'signin'
  properties: {
    enabled: false
...
resource service_apimmultirmoreirao_name_signup 'Microsoft.ApiManagement/service/portalsettings@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'signup'
  properties: {
    enabled: true
...
resource service_apimmultirmoreirao_name_starter 'Microsoft.ApiManagement/service/products@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'starter'
  properties: {
    displayName: 'Starter'
...
resource service_apimmultirmoreirao_name_unlimited 'Microsoft.ApiManagement/service/products@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'unlimited'
  properties: {
...
resource service_apimmultirmoreirao_name_master 'Microsoft.ApiManagement/service/subscriptions@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: 'master'
  properties: {
    scope: '${service_apimmultirmoreirao_name_resource.id}/'
...
resource service_apimmultirmoreirao_name_AccountClosedDeveloper 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_ApplicationApprovedNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_ConfirmSignUpIdentityDefault 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_EmailChangeIdentityDefault 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_InviteUserNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_NewCommentNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_NewDeveloperNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_NewIssueNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_PasswordResetByAdminNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_PasswordResetIdentityDefault 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_PurchaseDeveloperNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_QuotaLimitApproachingDeveloperNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_RejectDeveloperNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_RequestDeveloperNotificationMessage 'Microsoft.ApiManagement/service/templates@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
...
resource service_apimmultirmoreirao_name_1 'Microsoft.ApiManagement/service/users@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: '1'
  properties: {
...
resource service_apimmultirmoreirao_name_echo_api_create_resource 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
  ...
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_echo_api_modify_resource 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
...
resource service_apimmultirmoreirao_name_echo_api_remove_resource 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
...
resource service_apimmultirmoreirao_name_echo_api_retrieve_header_only 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
...
resource service_apimmultirmoreirao_name_echo_api_retrieve_resource 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
...
resource service_apimmultirmoreirao_name_echo_api_retrieve_resource_cached 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
...
resource service_apimmultirmoreirao_name_echo_api_default 'Microsoft.ApiManagement/service/apis/wikis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api
  name: 'default'
  properties: {
    documents: []
...
resource service_apimmultirmoreirao_name_administrators_1 'Microsoft.ApiManagement/service/groups/users@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_administrators
  name: '1'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_developers_1 'Microsoft.ApiManagement/service/groups/users@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_developers
  name: '1'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_echo_api 'Microsoft.ApiManagement/service/products/apis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'echo-api'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_echo_api 'Microsoft.ApiManagement/service/products/apis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: 'echo-api'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_administrators 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'administrators'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_administrators 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: 'administrators'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_developers 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'developers'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_developers 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: 'developers'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_guests 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'guests'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_guests 'Microsoft.ApiManagement/service/products/groups@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: 'guests'
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_policy 'Microsoft.ApiManagement/service/products/policies@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'policy'
  properties: {
...
resource service_apimmultirmoreirao_name_starter_default 'Microsoft.ApiManagement/service/products/wikis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'default'
  properties: {
    documents: []
...
resource service_apimmultirmoreirao_name_unlimited_default 'Microsoft.ApiManagement/service/products/wikis@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: 'default'
  properties: {
    documents: []
...
resource service_apimmultirmoreirao_name_echo_api_create_resource_policy 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api_create_resource
  name: 'policy'
  properties: {
  ...
  dependsOn: [
    service_apimmultirmoreirao_name_echo_api
    service_apimmultirmoreirao_name_resource
  ]
}

resource service_apimmultirmoreirao_name_echo_api_retrieve_header_only_policy 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api_retrieve_header_only
  name: 'policy'
  properties: {
...
resource service_apimmultirmoreirao_name_echo_api_retrieve_resource_cached_policy 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_echo_api_retrieve_resource_cached
  name: 'policy'
  properties: {
...
resource service_apimmultirmoreirao_name_starter_125BFC32_E2B2_4F48_BB2D_3872C5B7D467 'Microsoft.ApiManagement/service/products/apiLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: '125BFC32-E2B2-4F48-BB2D-3872C5B7D467'
  properties: {
    apiId: service_apimmultirmoreirao_name_echo_api.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_4D27EC1C_7753_4AFD_A2FE_9B2438BF6C86 'Microsoft.ApiManagement/service/products/apiLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: '4D27EC1C-7753-4AFD-A2FE-9B2438BF6C86'
  properties: {
    apiId: service_apimmultirmoreirao_name_echo_api.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
...
resource service_apimmultirmoreirao_name_starter_013D9A97_218E_472F_98D0_660BB7068F45 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: '013D9A97-218E-472F-98D0-660BB7068F45'
  properties: {
    groupId: service_apimmultirmoreirao_name_developers.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_5CF9D04E_1C4C_45EE_96BC_777884BA6989 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: '5CF9D04E-1C4C-45EE-96BC-777884BA6989'
  properties: {
    groupId: service_apimmultirmoreirao_name_administrators.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_unlimited_7B5628DC_3A45_4DD1_BA67_D155EAF5A446 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: '7B5628DC-3A45-4DD1-BA67-D155EAF5A446'
  properties: {
    groupId: service_apimmultirmoreirao_name_developers.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
...
resource service_apimmultirmoreirao_name_starter_827D89D1_63FD_417D_9199_44C6C0B14B70 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: '827D89D1-63FD-417D-9199-44C6C0B14B70'
  properties: {
    groupId: service_apimmultirmoreirao_name_administrators.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
...
resource service_apimmultirmoreirao_name_unlimited_8D25E087_5C43_4BEA_9804_061F04E28241 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_unlimited
  name: '8D25E087-5C43-4BEA-9804-061F04E28241'
  properties: {
    groupId: service_apimmultirmoreirao_name_guests.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
}

resource service_apimmultirmoreirao_name_starter_A2AF401C_EAE2_4086_A71B_38476F7C8707 'Microsoft.ApiManagement/service/products/groupLinks@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_starter
  name: 'A2AF401C-EAE2-4086-A71B-38476F7C8707'
  properties: {
    groupId: service_apimmultirmoreirao_name_guests.id
  }
  dependsOn: [service_apimmultirmoreirao_name_resource]
...
resource service_apimmultirmoreirao_name_65e1aa9d2ba5fb0068070001 'Microsoft.ApiManagement/service/subscriptions@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: '65e1aa9d2ba5fb0068070001'
  properties: {
    ownerId: service_apimmultirmoreirao_name_1.id
    scope: service_apimmultirmoreirao_name_starter.id
    state: 'active'
    allowTracing: false
    displayName: subscriptions_65e1aa9d2ba5fb0068070001_displayName
  }
}

resource service_apimmultirmoreirao_name_65e1aa9d2ba5fb0068070002 'Microsoft.ApiManagement/service/subscriptions@2023-03-01-preview' = {
  parent: service_apimmultirmoreirao_name_resource
  name: '65e1aa9d2ba5fb0068070002'
  properties: {
    ownerId: service_apimmultirmoreirao_name_1.id
    scope: service_apimmultirmoreirao_name_unlimited.id
    state: 'active'
    allowTracing: false
    displayName: subscriptions_65e1aa9d2ba5fb0068070002_displayName
  }
}
